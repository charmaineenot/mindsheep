          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <div className="collapse" id="innaCollapse">
                  <p className="lead text-lg-start text-center">
                    That's why we don't just target the right keywords and
                    audiences with our Full Funnel Approach.
                  </p>
                  <p className="lead text-lg-start text-center">
                    We also focus on crafting effective copy, creating
                    compelling creatives, and targeting the right audience for
                    your business.
                  </p>
                  <p className="lead text-lg-start text-center">
                    We even take it leaps further by optimizing your website for
                    speed and security, giving you a winning advantage of up to
                    20%.
                  </p>
                  <p className="lead text-lg-start text-center">
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <div className="collapse" id="theresaCollapse">
                  <p className="lead text-lg-start text-center">
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <div className="collapse" id="julesCollapse">
                  <p className="lead text-lg-start text-center">
                    When things are going right, we won't just leave it at that
                    - we'll explain why and work to build on it. And when things
                    go wrong, we'll be quick to identify the issue and work to
                    address it.
                  </p>
                  <p className="lead text-lg-start text-center">
                    We believe that honest communication is key to any
                    successful partnership. You can count on us to keep you
                    informed every step of the way, with regular updates and
                    clear explanations.
                  </p>
                  <p className="lead text-lg-start text-center">
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <div className="collapse" id="charmCollapse">
                  <p className="lead text-lg-start text-center">
                    With AI, we're able to optimize campaigns faster and more
                    efficiently, allowing us more time for collaboration and
                    strategy development. It's like having the smartest team
                    member working alongside us.
                  </p>
                  <p className="lead text-lg-start text-center">
                    Our team utilizes AI to analyze data and insights to create
                    targeted campaigns that deliver real results. We believe
                    that getting all the elements right is essential to success,
                    and with AI, we're able to do just that. Partner with
                    Mindsheep today and see how we can help take your business
                    to the next level
                  </p>
                </div>
                <div className="d-flex justify-content-center justify-content-lg-start pb-5">
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <div className="collapse" id="teamCollapse">
                  <p className="lead text-lg-start text-center">
                    We take the time to understand your business and challenges
                    to create a customized plan that drives real results. With
                    our dedicated team and cutting-edge solutions, we help you
