...
export default function Section4() {
  return (
    <div className="container-fluid px-0">
      <div className="container-fluid position-relative px-0 py-5">
        ...
        <div className="container py-5">
          ...
          <p className="stat fs-2 text-center">
            Discover the Power of Collaboration
          </p>
          <p className="lead fs-3 text-center">Why Choose Minsheep?</p>
        </div>
      </div>
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <p className="lead text-lg-start text-center">
                  We also focus on crafting effective copy, creating compelling
                  creatives, and targeting the right audience for your business.
                </p>
                <p className="lead text-lg-start text-center">
            ...
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <p className="lead text-lg-start text-center">
                  ...
                  we'll explain why and work to build on it. And when things go
                  wrong, we'll be quick to identify the issue and work to
                  address it.
                </p>
                <p className="lead text-lg-start text-center">
            ...
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <p className="lead text-lg-start text-center">
                  ...
                  targeted campaigns that deliver real results. We believe that
                  getting all the elements right is essential to success, and
                  with AI, we're able to do just that. Partner with Mindsheep
                  today and see how we can help take your business to the next
                  level
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-6 d-flex align-items-center px-lg-5 pt-5 pt-lg-0">
            <div className="container px-lg-5">
              <div className="container px-lg-5">
                ...
                <p className="lead text-lg-start text-center">
                  We take the time to understand your business and challenges to
                  create a customized plan that drives real results. With our
                  dedicated team and cutting-edge solutions, we help you reach
                  your full potential.
                </p>
                <p className="lead text-lg-start text-center">
                  {" "}
