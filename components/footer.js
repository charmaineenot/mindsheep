...
const Footer = ({elements}) => (
  <div className="Footer">
    <section className="align-items-center partners" style={footerStyle}>
      {/* Partners Section */}
      <div className="container-fluid pt-4 pb-4 p-5 bg-darken">
        <div className="boxed">
        ...
        <div className="row">
          ...
          <div class="col-lg-5 col-md-4 vmiddle text-center">
            ...
            <span className="text-grey me-2">
              <a href="https://www.facebook.com/mindsheepmarketing/" className="text-grey text-decoration-none"><FontAwesomeIcon icon={faFacebookSquare} size="3x"></FontAwesomeIcon></a>
            </span>
            <span className="text-grey">
              <a href="https://www.instagram.com/mindsheepmarketing/" target="_blank" className="text-grey text-decoration-none"><FontAwesomeIcon icon={faInstagramSquare} size="3x"></FontAwesomeIcon></a>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid p-3 pb-0 text-center text-sm-start">
        <div className="boxed">
          <div className="row">
            ...
            <div className="col-md-4" id="bBottom">
              <div className="footerSheepCont">
                <Image width="320" height="311" src="https://wp.mindsheep.com.au/wp-content/uploads/2021/10/Footer-Sheep-01-Mim-321x312-1.webp" />
              </div>
            </div>
      ...
      <div className="container p-3 text-center text-sm-start"> 
        <div className="row">
          ...
          <div class="col-lg-5 col-md-4 vmiddle text-center">
            <p className="text-black mb-0 d-none">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <span className="text-grey me-2">
              <a href="https://www.facebook.com/mindsheepmarketing/" className="text-grey text-decoration-none"><FontAwesomeIcon icon={faFacebookF} size="2x"></FontAwesomeIcon></a>
            </span>
            <span className="text-grey">
              <a href="https://www.instagram.com/mindsheepmarketing/" target="_blank" className="text-grey text-decoration-none"><FontAwesomeIcon icon={faInstagram} size="2x"></FontAwesomeIcon></a>
            </span>

            <div class="col-lg-5 col-md-4 vmiddle text-center">
              <span className="text-grey">Copyright @ 2021 Mindsheep. All Rights Reserved.</span>
          </div>
          </div>
