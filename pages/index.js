      ...
      <Layout page={pageData} elements={(elements,footerData)}>
        <section className={styles.homeBanner+" banner-section text-center"} style={bannerStyle}>
          ...
          <div className={styles.videoContainer+" float-start hide-sm"}>
            ...
            <img src="https://wp.mindsheep.com.au/wp-content/uploads/2022/11/ANIMATED-SHEEP-V1.gif" class="Home_videoBanner__qo6Ls"/>
          </div>
          ...
          <div className={styles.videoContainer+" float-start visible-sm"}>
            ...
            <img src="https://wp.mindsheep.com.au/wp-content/uploads/2022/11/ANIMATED-SHEEP-V1.gif" class="Home_videoBanner__qo6Ls" id="logo-hero"/>
          </div>
        </section>
