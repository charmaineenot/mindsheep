...
const content = ({ pageMeta, pageContent, footerContent }) => {
  ...
  return (
    <Layout page={pageData} elements={(elements, footerData)}>
      <section
        className={styles.homeBanner + " banner-section text-center"}
        style={bannerStyle}
      >
        ...
        <div className={styles.videoContainer + " float-start hide-sm"}>
          ...
          <img
            src="https://wp.mindsheep.com.au/wp-content/uploads/2022/11/MindSheep-Fawn-Mickey-v1.gif"
            class="Home_videoBanner__qo6Ls"
          />
        </div>
        <div
          className={
        ...
        >
          ...
          <img
            src="https://wp.mindsheep.com.au/wp-content/uploads/2022/11/Text-on-loop-Revel-diagonally_None-1.gif"
            class="Home_videoBanner__qo6Ls"
          />
          <div>
            <a
              href="#services"
              className={
                styles.btnViewServices + " btn btn-warning btnViewServices-sm"
              }
            >
              VIEW SERVICES
            </a>
                ...
                <div className="statData-r">
                  <div className="stat text-orange hide-sm">
                    ...
                    <h5 className="text-orange">
                      {elements.homeStats.stat1Heading}
                    </h5>
                  </div>
                  ...
                  <div className="statTestimonial text-white p-3 mt-4 hide-sm">
                    <p>
                      <em>{elements.homeStats.stat1Testimonial}</em>
                    </p>
                    <span className="text-orange fw-bold">
                      {elements.homeStats.stat1Client}
                    </span>
                    <br />
                    <span className="text-orange">
                      {elements.homeStats.stat1Company}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="row  s-2">
                ...
                <div className="statData-r">
                  <div className="stat text-orange hide-sm">
                    ...
                    />
                    <h5 className="text-orange">
                      {elements.homeStats.stat2Heading}
                    </h5>
                  </div>
                  <div className="stat text-orange visible-sm">
                    <h5 className="text-orange">
                  ...
                  <div className="statTestimonial text-white p-3 mt-4 hide-sm">
                    <p>
                      <em>{elements.homeStats.stat2Testimonial}</em>
                    </p>
                    <span className="text-orange fw-bold">
                      {elements.homeStats.stat2Client}
                    </span>
                    <br />
                    <span className="text-orange">
                      {elements.homeStats.stat2Company}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="row s-2">
                ...
                <div className="statData-r">
                  <div className="stat text-orange hide-sm">
                    ...
                    />
                    <h5 className="text-orange">
                      {elements.homeStats.stat3Heading}
                    </h5>
                  </div>
                  <div className="stat text-orange visible-sm">
                    <h5 className="text-orange">
                  ...
                  <div className="statTestimonial text-white p-3 mt-4 hide-sm">
                    <p>
                      <em>{elements.homeStats.stat3Testimonial}</em>
                    </p>
                    <span className="text-orange fw-bold">
                      {elements.homeStats.stat3Client}
                    </span>
                    <br />
                    <span className="text-orange">
                      {elements.homeStats.stat3Company}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="row s-2">
                ...
                <div className="statData-r">
                  <div className="stat text-orange hide-sm">
                    ...
                    <h5 className="text-orange">
                      {elements.homeStats.stat4Heading}
                    </h5>
                  </div>
                  <div className="stat text-orange visible-sm">
                    <h5 className="text-orange">
                  ...
                  <div className="statTestimonial text-white p-3 mt-4 hide-sm">
                    <p>
                      <em>{elements.homeStats.stat4Testimonial}</em>
                    </p>
                    <span className="text-orange fw-bold">
                      {elements.homeStats.stat4Client}
                    </span>
                    <br />
                    <span className="text-orange">
                      {elements.homeStats.stat4Company}
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="whyUs-section pt-5 pb-5 mb--100">
        <div className="container">
          <div className="text-center">
            <h2 className="sectionTitle whyUsHeading">
              {elements.homeWhyUs.whyUsHeading}
            </h2>
          </div>
          <div className="row mt-1">
            <div className="col-md-4 mtsm1">
              <div className="card m-20 pt-3 h-100 p-lr-2">
                <div className="card-body text-center position-relative">
                  <Image
                    src={elements.homeWhyUs.whyUs1Icon.sourceUrl}
                    width="100"
                    height="100"
                  />
                  <h5 className="card-title mt-4 text-orange">
                    {elements.homeWhyUs.whyUs1Title}
                  </h5>
                  <p className="card-text mt-4 mb-0">
                    {elements.homeWhyUs.whyUs1Description}
                  </p>
                  <a
                    href="/lead-generation"
                    className={styles.btnWhyUs + " btn btn-warning top-100 "}
                  >
                    LEARN MORE
                  </a>
                </div>
            ...
            <div className="col-md-4 mtsm1">
              <div className="card m-20 pt-3 h-100 ">
                <div className="card-body text-center position-relative">
                  <Image
                    src={elements.homeWhyUs.whyUs2Icon.sourceUrl}
                    width="100"
                    height="100"
                  />
                  <h5 className="card-title mt-4 text-orange">
                    {elements.homeWhyUs.whyUs2Title}
                  </h5>
                  <p className="card-text mt-4 mb-0">
                    {elements.homeWhyUs.whyUs2Description}
                  </p>
                  <a
            ...
            <div className="col-md-4 mtsm1">
              <div className="card m-20 pt-3 h-100">
                <div className="card-body text-center position-relative">
                  <Image
                    src={elements.homeWhyUs.whyUs3Icon.sourceUrl}
                    width="100"
                    height="100"
                  />
                  <h5 className="card-title mt-4 text-orange">
                    {elements.homeWhyUs.whyUs3Title}
                  </h5>
                  <p className="card-text mt-4 mb-0">
                    {elements.homeWhyUs.whyUs3Description}
                  </p>
                  <a
                    href="/brand-building"
                    className={styles.btnWhyUs + " btn btn-warning top-100"}
      ...
      <section className="bg-darken short-d">
        <div className="container p-5">
          <p className="p-0 mt-3 text-white text-center sm-p-0 short-descriptions">
            <i>{elements.homeAbout.shortDescription}</i>
          </p>
          <p className="p-0 mt-5 text-white text-center sm-p-0 short-descriptions">
            <i>{elements.homeAbout.shortDescription2}</i>
          </p>
        </div>
      </section>
      <section className="services-section pt-8 pb-10" id="services">
        <div className="container">
          <div className="text-center">
            <h2 className="sectionTitle HomeServicesHading">
              {elements.homeServices.servicesHeading}
            </h2>
          ...
          <div className="row" id="row-services">
            <div className="col-md-3 text-center w-24">
              <a href="/lead-generation">
                <Image
                  src={elements.homeServices.homeServices1Icon.sourceUrl}
                  width={150}
                  height={150}
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices1Title}
                </h5>
              </a>
            </div>
            <div className="col-md-3 text-center w-24">
              <a href="/automate-your-business w-20">
                <Image
                  src={elements.homeServices.homeServices2Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices2Title}
                </h5>
              </a>
            </div>
            <div className="col-md-3 text-center w-24">
              <a href="/automate-your-business/#bot-automation">
                <Image
                  src={elements.homeServices.homeServices3Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10 ">
                  {elements.homeServices.homeServices3Title}
                </h5>
              </a>
            </div>
            <div className="col-md-3 text-center w-24">
              <a href="/brand-building/#graphic-design">
                <Image
                  src={elements.homeServices.homeServices6Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices6Title}
                </h5>
              </a>
            </div>
          </div>
          <div className="row" id="row-services">
            ...
            <div className="col-md-3 text-center w-24">
              <a href="/automate-your-business/#web-design-development">
                <Image
                  src={elements.homeServices.homeServices4Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices4Title}
                </h5>
              </a>
            </div>
            <div className="col-md-4 text-center w-24">
              <a href="/brand-building">
                <Image
                  src={elements.homeServices.homeServices5Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices5Title}
                </h5>
              </a>
            </div>
            <div className="col-md-3 text-center w-24">
              <a href="/brand-building/#social-media">
                <Image
                  src={elements.homeServices.homeServices7Icon.sourceUrl}
                  width="150"
                  height="150"
                />
                <h5 className="mt-3 mb-4 fs-10">
                  {elements.homeServices.homeServices7Title}
                </h5>
              </a>
            </div>
            <div className="col-md-1"></div>
  ...
  return {
    props: {
      pageMeta: {
        ...
        description:
          "More Leads. Simply Stand Out. Mindsheep uses proven marketing tactics to generate high-value leads for businesses in Australia. Contact us today!",
      },
      pageContent,
      footerContent,
    },
